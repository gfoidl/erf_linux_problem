...
.LCPI1_3:
	.quad	-4615913072587595475    # double -1.0614054289999999
.LCPI1_4:
	.quad	4609223234099956793     # double 1.453152027
.LCPI1_5:
	.quad	-4614291739287821993    # double -1.4214137410000001
.LCPI1_6:
	.quad	4598796657494856809     # double 0.28449673599999997
.LCPI1_7:
	.quad	-4625109815114573186    # double -0.25482959199999999
.LCPI1_9:
...
.Ltmp0:
	...
	mulsd	xmm0, qword ptr [rsp]   # 8-byte Folded Reload
	...
	movapd	xmm1, xmm3
	andnpd	xmm1, xmm2
	movsd	xmm2, qword ptr [rip + .LCPI1_9] # xmm2 = mem[0],zero
	andpd	xmm2, xmm3
	orpd	xmm2, xmm1
	mulsd	xmm0, xmm2
	add	rsp, 40
